...
export const ProfessionalTemplate = ({ quote, brand }: { quote: Quote; brand: BrandSettings }) => {
  ...
  return (
    <div
      className="bg-white font-sans text-gray-900 max-w-[210mm] mx-auto"
      style={{
        fontSize: '10pt',
        lineHeight: '1.4',
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="text-right min-w-[180px]">
            ...
            <table className="text-xs ml-auto border-collapse">
              <tbody>
                <tr>
                  <td className="text-right pr-2 py-1 font-semibold text-gray-700">DATE:</td>
                  <td className="border border-gray-300 px-2 py-1 bg-gray-50 min-w-[100px]">{quote.date}</td>
                </tr>
                <tr>
                  <td className="text-right pr-2 py-1 font-semibold text-gray-700">QUOTE #:</td>
                  <td className="border border-gray-300 px-2 py-1 bg-gray-50 font-mono">{quote.ref}</td>
                </tr>
                <tr>
                  <td className="text-right pr-2 py-1 font-semibold text-gray-700">VALID UNTIL:</td>
      ...
      <div className="mb-6">
        <table className="w-full border-collapse text-xs">
          ...
          <tbody>
            ...
            {Array.from({ length: Math.max(0, 5 - quote.groups.reduce((sum, g) => sum + g.items.length, 0)) }).map((_, i) => (
              <tr key={`empty-${i}`}>
            ...
            <table className="w-full text-xs border-collapse">
              <tbody>
                ...
                {quote.status === "INVOICED" && (
                  <>
                    <tr>
                      <td className="text-right px-3 py-1.5 border border-gray-300 bg-gray-50">Tax (if applicable):</td>
                      <td className="text-right px-3 py-1.5 border border-gray-300 bg-gray-50 tabular-nums">₦</td>
                      <td className="text-right px-3 py-1.5 border border-gray-300 bg-gray-50 tabular-nums">0.00</td>
                    </tr>
                  </>
                )}
